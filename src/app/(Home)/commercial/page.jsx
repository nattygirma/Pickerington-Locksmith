...
import featuredImg1 from '../../../../public/images/new/s1.jpeg';
import featuredImg2 from '../../../../public/images/new/s2.jpeg';
import featuredImg3 from '../../../../public/images/new/s3.jpeg';
      ...
      <section className="section section-lg section-bottom-0 has-shape">
        ...
        <div className="container">
          <FeatureCardStyle3
            ...
            subtitle="Weawr and tear will happen with any business lock. Your business is 
            should remain secure, but having a broken lock can disturb that security. We specialize 
            in commercial lock repair offering both fast and affordable solutions in Westerville,
             Ohio. Contact us today for all your commercial lock repair needs."
            imgUrl={featuredImg1}
          ...
          <FeatureCardStyle4
            number="02"
            title="Commercial Rekey & Master Rekey"
            subtitle="Sometimes you just need to have your business lock re-keyed. Our commercial
             locksmiths can have your business or residential door re-keyed. Often landlords should 
             rekey the property to ensure no one has access or keys to a unit. Regardless your business 
             model, reach out to us today and we can have your business rekeyed promptly."
            // featureList={[
          ...
          <FeatureCardStyle3
            number="03"
            title="Commercial Key Extraction"
            subtitle="It happens, your key is stuck inside the lockhole or cylinder and your unable to do 
            anything. We have you covered with fast and affordable locksmiths,
             mobile and ready in Westerville Ohio. Let our technician extract a broken key, reprogram a keypad
             ,and get you squared away. Contact us for more information."
            imgUrl={featuredImg3}
